...
function Navbar(props) {
    ...
    return (
        <div className={`stroke-black drop-shadow-lg  py-5 z-50  text-white w-full flex items-center px-16 font-["Bebas"] justify-between transition-colors duration-300 `}>
